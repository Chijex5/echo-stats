...
var cache = (_a = global._mongoose) !== null && _a !== void 0 ? _a : { conn: null, promise: null };
...
function getMongoConnectionErrorMessage(error) {
    ...
    if (message.includes("Could not connect to any servers") ||
        ...
        return [
            ...
            "Original error: ".concat(message),
        ].join(" ");
    }
    return "Could not connect to MongoDB. Original error: ".concat(message);
}
function connectDB() {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    cache.conn = null;
                    cache.promise = null;
                    throw new Error(getMongoConnectionErrorMessage(error_1), { cause: error_1 });
